...
export type replaceRequirements_Errors =
  'VALIDATION_FAILED' | 'UNAUTHENTICATED' | 'PROJECT_NOT_FOUND'
...
export type confirmConcepts_Errors =
  'CONCEPT_MAPPING_NOT_FOUND' | 'VALIDATION_FAILED' | 'UNAUTHENTICATED' | 'PROJECT_NOT_FOUND'
...
export type createProject_Errors =
  'VALIDATION_FAILED' | 'UNAUTHENTICATED' | 'PROJECT_NAME_DUPLICATED'
...
export type updateSchedule_Errors = 'VALIDATION_FAILED' | 'UNAUTHENTICATED' | 'PROJECT_NOT_FOUND'
...
export type findRounds_Errors = 'UNAUTHENTICATED' | 'PROJECT_NOT_FOUND'
...
export type findConceptCandidates_Errors = 'UNAUTHENTICATED' | 'PROJECT_NOT_FOUND'
