...
import type { findMyDisclosure_Path } from './disclosureTypes'
...
export const disclosureKeys = {
  ...
  findMyDisclosure: (params: { path: findMyDisclosure_Path }) =>
    [...disclosureKeys.all, 'findMyDisclosure', params.path ?? null] as const,
}
