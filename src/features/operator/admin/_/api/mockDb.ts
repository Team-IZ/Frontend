...
export const COHORTS: MockCohort[] = [
  /*
    **8기는 7기가 끝나갈 때 시작한다.** 부트캠프는 한 번에 한 기수를 돌리므로 두 기수가
    ...
    비용 화면에 두 기수가 나란히 떴다(OP06-16). 겹치는 것은 **전환기 한두 달**뿐이고,
...
export const MANAGERS: Manager[] = [
  ...
  },
  {
    ...
    // **7기 매니저로 초대받았다** — 반은 아직 없어도 소속은 있다(OP06-15)
    cohortIds: ['7'],
    assignments: [],
    pastCohorts: 0,
    headcount: null,
  ...
  },
  {
    ...
    */
    ...
    /*
      **6기 소속이라 7기 목록에는 안 나온다**(OP06-15). 6기 때 퇴사한 사람을 7기 운영 화면에서
